    ...
    <div className="min-h-screen bg-industrial-bg">
      <header className="h-16 border-b border-industrial-line/10 bg-white flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          <div className="h-9 px-4 flex items-center justify-center bg-green-600">
            <span className="text-white font-bold text-base tracking-wide">FRANKY</span>
          </div>
          <div className="h-6 w-[1px] bg-industrial-line/20" />
          <span className="font-mono text-sm font-bold uppercase tracking-wide text-industrial-ink">Material Management Dashboard</span>
        </div>
        <button
